...
if ( ! isset( $color_scheme[2] ) ) {
	...
	$custom_css = "
		...
		.bt_bb_column .bt_bb_column_content.bt_bb_color_scheme_inner_{$scheme_id} {
			color: {$color_scheme[1]};
			background-color: {$color_scheme[2]};
		}
		...
		.bt_bb_column_inner .bt_bb_column_inner_content.bt_bb_color_scheme_inner_{$scheme_id} {
			color: {$color_scheme[1]};
			background-color: {$color_scheme[2]};
		}
