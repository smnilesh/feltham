...
class bt_bb_column_inner extends BT_BB_Element {
	...
	function handle_shortcode( $atts, $content ) {
		...
		if ( $color_scheme_inner != '' ) {
			$inner_class[] = $this->prefix . 'color_scheme_inner' . '_' . bt_bb_get_color_scheme_id( $color_scheme_inner );
		}
	...
	function map_shortcode() {		
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Inner Column', 'bold-builder' ), 'description' => esc_html__( 'Inner Column element', 'bold-builder' ), 'width_param' => 'width', 'container' => 'vertical', 
			...
			'params' => array(
				...
				array( 'param_name' => 'color_scheme_inner', 'type' => 'dropdown', 'heading' => esc_html__( 'Inner color scheme', 'bold-builder' ), 'value' => $color_scheme_arr, 'group' => esc_html__( 'Design', 'bold-builder' )  ),
