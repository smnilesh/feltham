	...
	if ( isset( $wrap_arr['d0'] ) && $wrap_arr['d0'] != '' ) {
		...
		if ( current_user_can( 'edit_pages' ) ) {
			if ( $bt_footer ) {
				...
				$wrap_arr['d0'] .= '<span id="bt_bb_fe_preview_toggler" class="bt_bb_fe_preview_toggler">' . esc_html__( 'Show/hide edit mode UI', 'bold-builder' ) . '</span><span id="bt_bb_fe_save" title="' . esc_attr__( 'Save changes', 'bold-builder' ) . '"></span>';				
			}
		}
