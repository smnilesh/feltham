							...
							<div class="bt_bb_column col-md-12 col-ms-12 bt_bb_align_left bt_bb_vertical_align_top bt_bb_animation_fade_in animate bt_bb_padding_normal animated" data-width="12">
								<div class="bt_bb_column_content">
									...
									echo boldthemes_get_heading_html(
										array(
											'headline' => esc_html__( 'We are sorry, no results for: ', 'wheelco' ) . get_search_query(),
											'subheadline' => '',
											'size' => 'large'
										)
									);
									...
									<form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
										<input type="search" value="<?php echo esc_attr( get_search_query() )  ?>" placeholder="<?php echo esc_attr__( 'Enter search term', 'wheelco')  ?>" name="s" id="s" >
										<input type="submit" value="<?php echo esc_attr__( 'Search', 'wheelco')  ?>">
									</form>
									...
									<?php
										echo boldthemes_get_button_html( 
											array (
												'url' => home_url( '/' ), 
												'text' => esc_html__( 'BACK TO HOME', 'wheelco' ), 
												'style' => 'filled',
												'color_scheme' => 'light-accent-skin',
												'size' => 'small'
											)
										);
									?>
